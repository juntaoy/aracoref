...
class CorefModel(object):
  ...
  def tensorize_example(self, example, is_training,use_pred_mentions):
  ...
  def truncate_example(self, tokens, context_word_emb, head_word_emb, lm_emb, char_index, text_len, speaker_ids, genre, is_training, gold_starts, gold_ends, cluster_ids,pred_starts,pred_ends,use_pred_mentions):
  ...
  def get_pred_mention_scores(self, candidate_starts,candidate_ends, pred_mention_starts, pred_mention_ends, pred_mention_scores):
  ...
  def get_predictions_and_loss(self, tokens, context_word_emb, head_word_emb, lm_emb, char_index, text_len, speaker_ids, genre, is_training, gold_starts, gold_ends, cluster_ids,pred_starts, pred_ends,use_pred_mentions):
  ...
  def get_mention_scores(self, span_emb,scope_name = 'mention_scores'):
